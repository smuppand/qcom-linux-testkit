...
# Systemd boot KPI + validation (single run). POSIX sh.
...
EXCLUDE_SERVICES=""
# Metadata only – this script still runs once per invocation.
...
Options:
  --out DIR Output directory for logs (default: ./logs_${TESTNAME})
